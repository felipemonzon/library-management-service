...
public abstract class DatabaseConstant {
  ...
  /** Propiedad para el nombre de la tabla "categories_books". */
  public static final String CATEGORIES_BOOKS_TABLE = "categories_books";
  /** Propiedad para el campo "category id". */
  ...
  /** Propiedad para el nombre de la tabla "géneros". */
  public static final String GENRES_TABLE = "genres";
  /** Propiedad para el nombre de la tabla "genres_books". */
  public static final String GENRES_BOOKS_TABLE = "genres_books";
  /** Propiedad para el campo "genre book id". */
