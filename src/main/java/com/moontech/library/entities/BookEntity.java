...
public class BookEntity extends AuditableEntity {
  ...
  @ManyToMany
  @JoinTable(
      name = DatabaseConstant.GENRES_BOOKS_TABLE,
      joinColumns = @JoinColumn(name = DatabaseConstant.BOOK_ID_FIELD),
      inverseJoinColumns = @JoinColumn(name = DatabaseConstant.GENRE_ID_FIELD))
  @Column(name = DatabaseConstant.GENRE_ID_FIELD, nullable = false)
  @ToString.Exclude
